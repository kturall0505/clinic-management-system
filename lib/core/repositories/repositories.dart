...
class PatientRepository {
  ...
  Future<void> save(Patient patient) => _store.put(patient.id, patient.copyWith());
...
class DoctorRepository {
  ...
  Future<void> save(Doctor doctor) => _store.put(doctor.id, doctor.copyWith());
  Future<void> delete(String id) => _store.delete(id);
...
class AppointmentRepository {
  AppointmentRepository(AppDatabase db)
      : _store = _Store(db, 'appointments', Appointment.fromMap, (a) => a.toMap());
  final _Store<Appointment> _store;
  Future<void> save(Appointment appointment) => _store.put(appointment.id, appointment.copyWith());
  Future<void> delete(String id) => _store.delete(id);
